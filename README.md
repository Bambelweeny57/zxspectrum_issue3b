...
Special thanks to Liveboxandy for reconstructing the base footprints for the iBOM and 3D Models view and Dee for the Coil, Keyboard and Audio Connectors, Modulator, Speaker, ULA, CPU, ROM and Heat Sink 3D Models.
